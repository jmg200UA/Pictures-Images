...
<body>
    ...
    <?php
            ...
            if($_GET['idalbum']==1){
                $array1 = array();
                $i=0;
                $sentencia1 = 'SELECT Titulo,Descripcion,Pais,Album,Fecha,IdFoto from fotos WHERE album=1';
                $sentenciaA1 = 'SELECT albumes.Descripcion, Pais, Fecha, albumes.Titulo, IdAlbum FROM fotos, albumes WHERE Album=IdAlbum AND Album=1';
                ...
                while($fila1 = mysqli_fetch_assoc($resultado1)) {
                    ...
                    echo '<a href="DetalleFoto.php?idfoto='.$fila1['IdFoto'].'">';
                    echo "<p><strong>Foto del album:</strong>".$fila1['Titulo']." <strong> - Pais en el que fue tomada: </strong>$npais</p></a>";
                ...
                echo '<p><a href="PerfilUsu.php">Perfil del usuario</a></p>';
                echo '<p><a href="AñadirFotoAlbum.php?Titulo='.$albtit.'">Añadir foto al álbum</a></p>';
            }
            if($_GET['idalbum']==2){   
                $array2 = array();
                $i=0;
                $sentencia2 = 'SELECT Titulo,Descripcion,Pais,Album, Fecha, IdFoto from fotos WHERE album=2';
                ...
                while($fila2 = mysqli_fetch_assoc($resultado2)) {
                    ...
                    echo '<a href="DetalleFoto.php?idfoto='.$fila2['IdFoto'].'">';
                    echo "<p><strong>Foto del album:</strong>".$fila2['Titulo']." <strong> - Pais en el que fue tomada: </strong>$npais</p></a>"; 
